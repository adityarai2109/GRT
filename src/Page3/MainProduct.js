    ...
    <div>
      ...
      <div className="page3_content">
        <div className="product_image">
          <img src={Cardarray.find(x => x.id === props.id).image} alt="ProductImage"></img>
        </div>
        <div className="product_desc">
          <h1>{ida}</h1>
          <h1 className="title">{Cardarray.find(x => x.id === props.id).title}</h1>
          <p className="desc">
          {Cardarray.find(x => x.id === props.id).description}
          </p>
          <div className="buttons1">
            <PurpleButton line1={Cardarray.find(x => x.id === props.id).price} line2="* * * * *" />
