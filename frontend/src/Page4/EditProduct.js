...
const EditProduct = (props) => {
  ...
  let eProduct = props.products.filter(
  ...
  // }, []);
  const [name, setName] = useState(eProduct !== undefined ? eProduct.name : "");

  const [material, setMaterial] = useState(
    eProduct !== undefined ? eProduct.material : ""
  );
  const [design, setDesign] = useState(
    eProduct !== undefined ? eProduct.design : ""
  );
  const [description, setDescription] = useState(
    eProduct !== undefined ? eProduct.description : ""
  );
  const [price, setPrice] = useState(
    eProduct !== undefined ? eProduct.price : null
  );
  const [image, setImage] = useState(
    eProduct !== undefined ? eProduct.image : {}
  );
  const [bottomLength, setBottomLength] = useState(
    eProduct !== undefined ? eProduct.bottomLength : null
  );
  const [duppataLength, setDuppataLength] = useState(
    eProduct !== undefined ? eProduct.duppataLength : null
  );
  const [topLength, setTopLength] = useState(
    eProduct !== undefined ? eProduct.topLength : null
  );
                            ...
                            {!imgUpload ? (
                              eProduct !== undefined ? (
                                <img
                                  ...
                                  src={`http://localhost:5000/upload/${eProduct.image}`}
                                  alt=""
                                />
                              ) : null
                            ) : (
