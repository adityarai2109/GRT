...
import "./Carousel.css";
import image7 from "../images/carousel_collage1.png";
import image8 from "../images/carousel_collage1.png";
import image5 from "../images/carousel_collage1.png";
      ...
      >
        ...
        >
          <div className="carousel-inner relative overflow-hidden w-full">
            ...
            >
              <div
                className="block w-full text-white text-5xl text-center"
                style={{
            ...
            >
              <div
                className="block h-full w-full text-white text-5xl text-center"
                style={{
                  backgroundColor: "#f9c5d1",
                  backgroundImage:
                    "linear-gradient(135deg, #f9c5d1 0%, #9795ef 74%)",
