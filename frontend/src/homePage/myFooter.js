        ...
        <div class="px-2 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          >
            <svg
              ...
              stroke-width="2"
              class="w-10 h-10 text-white p-2 bg-indigo-100 rounded-full"
              viewBox="0 0 24 24"
            >
          ...
          <p class="text-sm text-gray-100 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-900 sm:py-2 sm:mt-0 mt-4">
            © 2021 Gangaram Textiles
          </p>

          <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a class="ml-5 text-gray-100" href=".">
              <svg
                fill="currentColor"
                stroke-linecap="round"
                stroke-linejoin="round"
